...
class formCriarAluno(forms.ModelForm):
	...
	usuario_nascimento = forms.CharField(label="Data de Nascimento", widget= forms.TextInput(attrs={'class': 'input-xlarge', 'placeholder': 'Data de Nascimento', 'type': 'date'}))
	...
	usuario_password = forms.CharField(label="Senha", widget= forms.PasswordInput(attrs={'class': 'form-control', 'placeholder': 'Senha'}))
